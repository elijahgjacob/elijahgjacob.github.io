      ...
      <div
        ...
        {!!profileImageSrc && (
          <div
            ...
            <div className="group relative h-40 w-40 overflow-hidden rounded-2xl shadow-xl ring-4 ring-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50 hover:ring-cyan-500/50 md:h-56 md:w-56">
              {/* Neon glow effect */}
